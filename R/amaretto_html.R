...
#' @param n_cluster 
#' @param wordcloud_bool 
#' @param hyper_geo_refence_name 
...
#' Title
#'
#' @param module_all_genes_data 
#' @param Module_Genes_names 
#' @param Module_regulators_weights 
#'
#' @return
#' @export
#'
...
#' @param outfile 
#' @param n_cluster 
#' @param all_gene_address 
#' @param show.overlapping.genes 
#' @param filter.genes 
#' @param show.unrecognized 
#'
#' @return
#' @export
#'
