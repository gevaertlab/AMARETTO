...
author:
  ...
  - name: Celine Everaert
    affiliation: Brigham and Women's Hospital, Harvard Medical School, Broad Institute of MIT and Harvard, Boston & Cambridge, MA, USA
  - name: Shaimaa Bakr
    affiliation: Stanford Center for Biomedical Informatics Research (BMIR), Department of Medicine and Biomedical Data Science, 1265 Welch Rd, Stanford, CA, USA
  - name: Mohsen Nabian
    affiliation: Brigham and Women's Hospital, Harvard Medical School, Broad Institute of MIT and Harvard, Boston & Cambridge, MA, USA
...
AMARETTOinit <- AMARETTO_Initialize(ProcessedDataLIHC, NrModules = 2, VarPercentage = 50)
...
AMARETTO_HTMLreport(AMARETTOinit,AMARETTOresults,
                    ProcessedDataLIHC,
                    hyper_geo_test_bool = TRUE,hyper_geo_reference = gmt_file, 
                    MSIGDB=TRUE)
